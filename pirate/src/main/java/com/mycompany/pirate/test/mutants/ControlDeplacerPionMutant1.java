 ...
 * @author RIBEIRO
 */
public class ControlDeplacerPionMutant1 implements IControlDeplacerPion {
    
    private PionRepository pionRepository;
    private Plateau plateau;
    private IDialogue notificationService;

    public ControlDeplacerPionMutant1(Plateau plateau, IDialogue notificationService, PionRepository pionRepository) {
